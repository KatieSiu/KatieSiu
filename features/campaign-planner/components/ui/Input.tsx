...
import { cn, interactiveFieldStyles } from "@/features/campaign-planner/lib/utils";
import { Search } from "@/features/campaign-planner/components/icons/outlined/Search";
...
const inputVariants = cva(
  [
    ...
    "text-[#1C2B33]",
    "font-optimistic",
    // Placeholder styling - gray color, disappears on focus
    ...
    // Disabled state
    "disabled:bg-[#F5F7F8] disabled:text-[#5C6970] disabled:cursor-not-allowed disabled:hover:bg-[#F5F7F8]",
  ],
  {
    variants: {
      hasError: {
