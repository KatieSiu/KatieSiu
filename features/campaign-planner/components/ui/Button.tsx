...
import { SmallTriangleDown } from "@/features/campaign-planner/components/icons/filled/SmallTriangleDown";

const buttonVariants = cva(
  // Base styles
  "inline-flex items-center justify-center border rounded-[4px] font-optimistic transition-all duration-150 disabled:cursor-not-allowed whitespace-nowrap shrink-0",
  {
    variants: {
      variant: {
        primary: [
