...
export function AdSetNameCard({ version, className = "" }: AdSetNameCardProps) {
  const [adSetName, setAdSetName] = useState("New Ad Set name");
        ...
        <div className="flex-1">
          <div className="bg-white border border-[#CBD2D9] rounded h-[36px] flex items-center px-3">
            <input
              ...
              className="w-full font-optimistic text-[14px] leading-[20px] text-[#1C2B33] outline-none bg-transparent"
            />
          </div>
        </div>

        {/* Create template button */}
        <button className="h-[36px] px-3 border border-[#A7B3BF] rounded bg-transparent hover:bg-[#F5F7F8] transition-colors">
