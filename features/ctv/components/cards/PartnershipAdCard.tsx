...
interface PartnershipAdCardProps {
...
export function PartnershipAdCard({ version, className = "" }: PartnershipAdCardProps) {
    ...
    <div className={`bg-white rounded-[4px] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.1),0px_0px_4px_0px_rgba(0,0,0,0.1)] p-4 w-[600px] ${className}`}>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="font-optimistic text-[14px] leading-[20px] text-[#1C2B33]">
          Run ads with creators, brands and other businesses. These ads leverage signals from both accounts to improve campaign performance.{" "}
          <span className="text-[#0A78BE] cursor-pointer hover:underline">About partnership ads</span>
        </p>
      </div>
      ...
      {isEnabled && (
        <div className="flex flex-col gap-2 mt-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            {/* Button options */}
            <button className="w-full h-[36px] bg-transparent border border-[#A7B3BF] rounded px-3 flex items-center justify-center hover:border-[#0A78BE] transition-colors">
